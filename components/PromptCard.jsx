  ...
  return (
    <div className='prompt_card'>
      <div className='flex justify-between items-start gap-5'>
        <div className='flex flex-1 justify-start gap-3 cursor-pointer'>
          <Image
        ...
        <div className='copy-btn' onClick={handleCopy}>
          <Image
            ...
            alt={ 
              copied == post.prompt ? 'tick_icon' : 'copy_icon'
            }
            width={12}
            height={12}
          />
      ...
      <p className='font-inter text-sm green_gradient cursor-pointer' onClick={() => handleTagClick && handleTagClick(post?.tag)}>{post.tag}</p>
